...
class PopularProduct extends StatelessWidget {
  ...
  // final double price;
  //
  // const PopularProduct({Key key, this.imageUrl, this.title, this.description, this.price}) : super(key: key);
  @override
                ...
                Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Icon(
                        Entypo.star,
                        color: wishlistProvider.getWishlistItems.containsKey(productsAttributes.id)? Colors.red : Colors.grey.shade800,
                      ),
                    ),
                    Positioned(
                      right: 10,
